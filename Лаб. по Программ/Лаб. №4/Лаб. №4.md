...
студента 1 курса группы ИВТ-б-о-192-2 Дубинина Дмитрия Александровича направления подготовки 09.03.01 "Информатика и вычислительная техника"
...
Основной файл (Osnovnoi.cpp) Код:
...
Вспомогательный файл(HelpFile.cpp) Код:
...
Заголовочный файл (header.h) Код:
